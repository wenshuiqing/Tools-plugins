    ...
    public class OutlineEffect : PostEffectBase
    {
        ...
        private Material blurMaterial
        {
            get
            {
                ...
                {
                    m_BlurMaterial = new Material(Shader.Find("GOE/Outline/Blur"));
        ...
        protected override void CreateMaterial()
        {
            if (material == null)
            {
                shader = Shader.Find("GOE/Outline/Outline");
                if (shader != null)
                {
        ...
        public override void Refresh()
        {
            ...
            if (m_SrcRenders != null)
            {
                ...
                {
                    Material replaceMat = new Material(Shader.Find("GOE/Outline/OutlineReplace"));
