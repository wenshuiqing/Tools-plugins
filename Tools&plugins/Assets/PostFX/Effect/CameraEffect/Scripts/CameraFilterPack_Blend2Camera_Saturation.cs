...
{
    [Serializable]
    public class CameraFilterPack_Blend2Camera_Saturation : PostEffectBase
    {
        ...
        protected override void CreateMaterial()
        {
            ...
            {
                base.shader = Shader.Find("CameraFilterPack/Blend2Camera_Saturation");
                if (base.shader != null)
                {
        ...
        {
            et = EffectType.Blend2Camera_Saturation;
            CreateMaterial();
        }
